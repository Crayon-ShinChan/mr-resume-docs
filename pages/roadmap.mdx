...
We leverage the power of [MDX](https://mdxjs.com/) to allow user to write their markdown resume with React components, which brings potential to do many cool stuff like integrating GPT into their resume.
...
In addition, PDF and website sometimes should have different styles, like the font size, margin, etc. Therefore, we will provide a way to allow user to customize their PDF style.
